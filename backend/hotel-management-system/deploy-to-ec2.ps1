...
Write-Host "🔗 EC2 API URL: http://$ec2IP:8081" -ForegroundColor Cyan
Write-Host "🔗 Frontend URL: http://hotel-management-ui.s3-website.ap-south-1.amazonaws.com" -ForegroundColor Cyan
Write-Host "🔍 Test Health: http://$ec2IP:8081/api/health" -ForegroundColor Cyan
